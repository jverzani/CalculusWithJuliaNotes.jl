...
For individual users `Julia` is installed quite easily with the `juliaup` utility or by other means. There are some brief installation notes in the overview of `Julia` commands.
