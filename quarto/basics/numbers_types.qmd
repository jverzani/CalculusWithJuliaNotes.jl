...
@tbl-real-number-types  compares different number types for storing a real number. The "closed under" column indicates which operations will return the same type as the inputs.


::: {#tbl-real-number-types}
